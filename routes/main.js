...
router.get('/api/tutorial', (req, res) => {
    res.sendFile(__path + '/docs/tutorial.html')
})

router.get('/api/cekapikey', (req, res) => {
    res.sendFile(__path + '/docs/invalidKey.html')
})

router.get('/api/wahyu', (req, res) => {
    res.sendFile(__path + '/docs/error.html')
})
...
var port = process.env.PORT || 8080 || 5000 || 3000 
    status = {
        ...
        info:{       
            owner: 'Handramz',            
            apikey: 'Chat Owner: https://wa.me/6283176474191'
        }
    }
    res.json(status)
})
